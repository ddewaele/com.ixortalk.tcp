 ...
 *
 */
@CapabilityDescription("The IxorTalkPutTcp processor receives a FlowFile and transmits the FlowFile content over a TCP connection to the configured TCP server. "
...
public class IxorTalkPutTcp extends AbstractPutEventProcessor {
