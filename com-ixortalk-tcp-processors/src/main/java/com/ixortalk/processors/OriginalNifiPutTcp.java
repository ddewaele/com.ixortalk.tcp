 ...
 */
package com.ixortalk.processors;
...
/**
 * <p>
 * The IxorTalkPutTcp processor receives a FlowFile and transmits the FlowFile content over a TCP connection to the configured TCP server. By default, the FlowFiles are transmitted over the same TCP
 ...
 *
 */
@CapabilityDescription("The OriginalNifiPutTcp processor receives a FlowFile and transmits the FlowFile content over a TCP connection to the configured TCP server. "
...
public class OriginalNifiPutTcp extends AbstractPutEventProcessor {
...
//                byte[] dataFromInputStream = IOUtils.toString(in,Charset.forName(context.getProperty(CHARSET).getValue())).getBytes();
//                getLogger().info("Found HEX OriginalNifiPutTcp : " + Hex.encodeHexString(dataFromInputStream));
